import { Clock, CreditCard, Shield, Smile, Star } from "lucide-react";
  ...
  return (
    <div className="bg-[#F1F1F1] pt-10 md:pt-0">
      <div className="container grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 lg:gap-12">
        <div className="md:col-span-1 w-full flex flex-col justify-center pt-5">
          ...
          <p className="text-sm md:text-base text-[#68706A] leading-[150%] font-normal">
            Our team are registered Specialist Orthodontists, dedicated to
            gentle, expert care and the latest treatments to create healthy,
          ...
          <ul className="pt-6 md:pt-8">
            ...
            <li className=" py-2 md:py-4">
              ...
              <span className="text-sm md:text-base font-[#505050] text-[#505050] leading-[120%] pt-2">
                To make orthodontic treatment affordable and stress-free for
                families.
              </span>
            </li>
          </ul>
        </div>
        <div className="md:col-span-1 relative h-[350px] md:h-[500px] lg:h-[600px]">
          <Image
